The program checks wheteher a maze has a solution where the maze is a PNG file or a JPEG file. To run, the program recieves the image as a file location from the command line arguments
